...
IF "%use_clang%"=="true" (
	...
	"C:\Program Files\LLVM\bin\clang" -march=native -Ofast -gcodeview -shared -o quote.dll quote.cpp
	REM "C:\Program Files\LLVM\bin\clang" -march=native -g -Ofast -shared -o quote.dll quote.cpp
REM 	>> quote_output.txt
